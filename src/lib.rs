...
pub const NNG_ZT_STATUS_UP: nng_zt_status = 0;
pub const NNG_ZT_STATUS_CONFIG: nng_zt_status = 1;
pub const NNG_ZT_STATUS_DENIED: nng_zt_status = 2;
pub const NNG_ZT_STATUS_NOTFOUND: nng_zt_status = 3;
pub const NNG_ZT_STATUS_ERROR: nng_zt_status = 4;
pub const NNG_ZT_STATUS_OBSOLETE: nng_zt_status = 5;
pub const NNG_ZT_STATUS_UNKNOWN: nng_zt_status = 6;
